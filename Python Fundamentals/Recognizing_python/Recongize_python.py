num1 = 42 # variable declaration, number initilazed
num2 = 2.3 # variable declaration, number initilazed
boolean = True # variable declaration, boolean initilazed
string = 'Hello World' # variable declaration, string initilazed
...
# print to console, Dicitonary access value
print(person['name'])
...
# for loop start at 0 and goes up to 5
for x in range(5):
    print(x)
# for loop start at 2 and goes up until 5
for x in range(2,5):
    print(x)
# for loop start at 2 goes up to until 10, increements by 3
...
def print_hello_x_times(x):
    # fro loop up until a given number x
    for num in range(x):
        # print to console 
        print('Hello')

# fucntion call arugment of 4
